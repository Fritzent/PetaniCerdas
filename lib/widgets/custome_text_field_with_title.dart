...
class CustomeTextFieldWithTitle extends StatefulWidget {
  ...
  const CustomeTextFieldWithTitle({
    super.key,
  ...
  @override
  State<CustomeTextFieldWithTitle> createState() =>
      _CustomeTextFieldWithTitleState();
}

class _CustomeTextFieldWithTitleState extends State<CustomeTextFieldWithTitle> {
